...
const Data = [
  {
    ...
    subtitle:
      "Our professional team is always at your service. We practice individual approach to every client, whether it us a large or a small project. Learn more about our services!",
  },
  {
    id: 2,
...
export default function Carousel({ carouselData = Data }) {
                  ...
                  <div className="row no-gutters">
                    <div className="content col-12 col-md-6 col-lg-4 offset-md-2">
                      <div>
                        ...
                        <p className="caption slide-content">
                          {slide.subtitle}
                        </p>
                      </div>
                    </div>
        ...
        <div className="main-slider-controls mt-10">
          <div className="center-div full h-100">
            <div className="row no-gutters h-100 align-items-md-start">
              <div className="main-slider-heading col-12 col-md-8 col-xlg-6 order-1 order-md-2 offset-md-2"></div>
              <div className="global-slider-nav-and-progress main-slider-nav-and-progress col-2 col-md-1 ml-auto d-flex flex-column order-3 align-self-end align-self-md-start mb-5 mb-md-0 pb-2 pb-md-0 mt-auto mt-md-0">
                <div className="global-slider-prev main-slider-prev">
                  <span>Prev.</span>
                </div>
                ...
                <div className="global-slider-next main-slider-next">
                  <span>Next</span>
                </div>
              </div>
            </div>
