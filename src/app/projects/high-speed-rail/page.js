...
export default function HighSpeedRailProject() {
  ...
  const projectData = {
    ...
    description: "Comprehensive high-speed rail network connecting major cities across Egypt with modern infrastructure. This transformative project will revolutionize transportation in Egypt, reducing travel times between major cities and supporting economic development across the country.",
    challenges: [
      "Complex terrain and geological conditions across multiple regions",
      "Integration with existing railway infrastructure",
      "Environmental impact considerations for sensitive areas",
      "Large-scale coordination across multiple governorates"
    ],
    solutions: [
      "Advanced engineering solutions for challenging terrain",
      "Comprehensive environmental impact assessment and mitigation",
      "State-of-the-art signaling and control systems",
      "Strategic planning for minimal disruption to existing services"
    ],
    features: [
      "High-speed trains operating at 250+ km/h",
      "Modern stations with advanced passenger facilities",
      "Advanced signaling and safety systems",
      "Energy-efficient design with regenerative braking",
      "Comprehensive maintenance and service facilities",
      "Integration with urban transportation networks"
    ],
    impact: [
      "Reduced travel times between major cities by 70%",
      "Enhanced connectivity and economic integration",
      "Reduced carbon emissions through modal shift",
      "Creation of thousands of jobs during construction and operation",
      "Improved accessibility for remote regions"
    ]
  };
